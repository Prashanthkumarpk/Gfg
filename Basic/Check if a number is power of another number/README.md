<h2><a href="https://practice.geeksforgeeks.org/problems/check-if-a-number-is-power-of-another-number5442/1?page=1&difficulty[]=-1&status[]=unsolved&company[]=Zoho&sortBy=submissions">Check if a number is power of another number</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two positive numbers X and Y, check if Y is a power of X or not.</span></p>
